...
class UpdateReviewRequest extends FormRequest
{
    ...
    {
        return [
            'cleanliness_rating' => 'sometimes|required|integer|min:1|max:5',
            'accuracy_rating' => 'sometimes|required|integer|min:1|max:5',
            'checkin_rating' => 'sometimes|required|integer|min:1|max:5',
            'communication_rating' => 'sometimes|required|integer|min:1|max:5',
            'location_rating' => 'sometimes|required|integer|min:1|max:5',
